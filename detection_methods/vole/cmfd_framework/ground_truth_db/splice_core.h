...
#ifndef VOLE_CMFDGT_SPLICE_CORE_H
#define VOLE_CMFDGT_SPLICE_CORE_H
...
public:
	...
	void add_global_cont_scale(double scale_factor);
	void add_global_discrete_scale(double scale_factor);
	...
	void splice(bool ground_truth_is_cmfd);
...
protected:
	...
	void splice(int snippet_no, cv::Point src_pos, bool is_source, bool ground_truth_is_cmfd);
...
#endif // VOLE_CMFDGT_SPLICE_CORE_H
